  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <button className={`p-2 mx-1 bg-emerald-100 rounded-lg ${show ? '' : 'hidden'}`} onClick={() => handleIncrement()}>+</button>
        <button className='p-2 bg-red-100 rounded-lg' onClick={() => {handleDecrement()}}>-</button>
          <span className="title-font font-medium text-2xl text-gray-900"> ${ producto.price * quantity }</span>
          <button className={`ml-6 bg-emerald-300 rounded-md`} onClick={() => addToCart(producto, quantity) }>Añadir al carrito</button>
