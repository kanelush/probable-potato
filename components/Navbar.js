...
<div className="container relative flex flex-wrap justify-between items-center mx-auto">
  <Link href="/">
      <span className=" cursor-pointer flex items-center self-center text-2xl  whitespace-nowrap font-bold mx-auto">@myweb</span>
  </Link>
  ...
  <div  className={`${Turnonn ? '' : 'hidden'} w-full md:block md:w-auto`} id="mobile-menu">
    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
      <Link href="/">
        <a href="" onClick={() => setTurnonn(false)} className="cursor-pointer block py-4 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Inicio</a>
      </Link>
      <Link href="/servicios">
